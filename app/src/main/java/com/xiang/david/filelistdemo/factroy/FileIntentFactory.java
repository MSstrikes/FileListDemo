...
public class FileIntentFactory {
    public Intent generateFileIntent(FileListItem fileItem){
        String suffix = fileItem.getFileType();
        StringBuilder filePath = new StringBuilder(fileItem.getAbsolutePath() + "/" + fileItem.getName());
        if (suffix.equals("txt") || suffix.equals("log")){
            return getTextFileIntent(filePath.toString(), false);
        } else if (suffix.equals("doc") || suffix.equals("docx")){
            return getWordFileIntent(filePath.toString());
        } else if (suffix.equals("ppt") || suffix.equals("pptx")){
            return getPptFileIntent(filePath.toString());
        } else if (suffix.equals("xls") || suffix.equals("xlsx")){
            return getExcelFileIntent(filePath.toString());
        } else if (suffix.equals("exe")) {
            return getAllIntent(filePath.toString());
        } else if (suffix.equals("zip") || suffix.equals("rar")){
            return getZipFileIntent(filePath.toString());
        } else if (suffix.equals("pdf")){
            return getPdfFileIntent(filePath.toString());
            ...
            return getVideoFileIntent(filePath.toString());
        } else {
            return getAllIntent(fileItem.toString());
        }
    }
